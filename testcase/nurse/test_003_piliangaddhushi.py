...
class TestAdd():
    ...
    @MASTER_HELPER.testcase("用例名：心之力批量添加护士")
    def test_addsomenurse_001(self):

        with MASTER_HELPER.step("批量添加护士"):
            self.login_page.xinzhili_login(username="abcdef123", password="111111")
            ...
            self.nurse_page.xinzhili_piliangaddhushi(file=u'C:\\Users\\87842\\Desktop\\Work\\uiTest-master\\resource\\护士模板.xlxs')
